<?php
	...
	if (!isset($_SESSION['propertyissueTransferList'])) {
		...
		$transferProperty->{'employee'} = $empIds;
	...
	$_SESSION['propertyissueTransferList'] = $propertyTransferList;
// echo	json_encode($propertyTransferList);
// 	return;
	include "showIssuePropertyTransfer.php";
?>
