<?php
  ...
  {
?>
<table class="dataTable border bordered hovered full-size" id="userShowHistoryBorrow">
    <thead>
      <tr>
...
<script>
var userShowHistoryBorrows = $("#userShowHistoryBorrow").DataTable({
  "processing": true,
  "serverSide": true,
  "ajax": "build/server_side/userBorrowHistory.php",
  oLanguage : {
    sProcessing : "<div data-role=\"preloader\" data-type=\"cycle\" data-style=\"color\"></div>"
  }
});
setInterval(function() {
  userShowHistoryBorrows.ajax.reload(null,false);
  console.log(1);
  }, 10000);
