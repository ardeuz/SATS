<?php
	...
	if(isset($_POST['requestedType'])){
		$sql = "SELECT request_code, remarks, transfer_to, released_from, date_request, emp_approval, CONCAT(b.last_name, ', ', b.first_name) AS emp_name, b.department FROM transfer_request AS a LEFT JOIN account_table AS b ON a.released_from=b.emp_id WHERE transfer_to = '$emp_id' AND emp_approval = 1 AND transfer_type = 'issuance' GROUP BY request_code";
		$color = 'green';
