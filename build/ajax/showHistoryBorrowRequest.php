<?php
  ...
  $sql = "SELECT ctrl_no, SUM(id) AS items_borrowed, CONCAT(b.last_name, ', ', b.first_name) AS borrowed_to, CONCAT(c.last_name, ', ', c.first_name) AS released_from, date_approved FROM borrow_request_history AS a LEFT JOIN account_table AS b ON a.borrowed_to=b.emp_id LEFT JOIN account_table AS c ON a.borrowed_to=c.emp_id GROUP BY ctrl_no";
...
<table class="dataTable border bordered hovered full-size">
    ...
    foreach ($transferHistoryDatas as $transferHistoryData)
      ...
      <tr>
        ...
        <td><?php echo $transferHistoryData['items_borrowed']?> </td>
