		...
		for ($i = 0; $i < count($employeeList); $i ++) {
			...
			<div class='cell padding20 shadow'>
		            ...
		            <p><small>" . $employeeList[$i]->{'department'}  . " Department</small></p>
								<span class='place-right'><small>Issued to</small></span><br/>
								<span class='sub-header place-right'>" . $accountsName['first_name'] . " " . $accountsName['last_name']
		            . "</span>
		            <p class='place-right'><small>" . $accountsName['department']  . " Department</small></p><br/>
								<br/>
								<br/>
								<br/>
								<hr class='thin' />";
