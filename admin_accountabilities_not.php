<?php
  ...
  $thisPage="NotPropertyAccountability";
?>
    ...
    <div class="flex-grid no-responsive-feature" style="height:100%;">
        ...
        <?php include_once('admin_navigation.php'); ?>
          <div class="cell auto-size padding20 no-margin-top grid container place-right" id="style-4" style="overflow-y:scroll;height:100%;">
            <h1 class="text-light fg-brown">Property Without Accountability<span class="mif-notification place-right text-light"></span></h1>
        ...
        <div data-role="dialog" data-overlay="true" data-overlay-color="op-dark" data-height="80%" data-width="65%" data-overlay-click-close="true" id="adminAccountabilityDialog" data-close-button="true" style="overflow-y:scroll;">
