...
<html charset="UTF-8" lang="en">
  ...
  <body>
    ...
    <div class="cell full-size padding50 bg-white" id="cell-content" style="width:100%;">
      <h1 class="text-light fg-lightBlue">My Transfer Request<span class="mif-notification place-right text-light"></span></h1>
    ...
    <div class='cell full-size padding50 bg-white' id='cell-content' style='width:100%;'>
      ...
      <hr class="thin bg-grayLighter">
      <center>
        <div class="container grid padding10" id="requestFormBorrow" style="display:none;"> </div>
        <div id="requestFormBorrowPreloader" ></div>
