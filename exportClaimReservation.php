<?php
  ...
  DATE_FORMAT(date,'%m-%d-%Y') AS date_released, or_no, DATE_FORMAT(or_date,'%m-%d-%Y') AS or_date FROM proware_claim AS a
  ...
  header("Content-Disposition: attachment; filename=claim_reservation.xls");
